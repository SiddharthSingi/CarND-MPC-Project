      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
		  ...
		  //Debugging
		  //for (int i = 0; i < eigen_ptsx.size(); i++)
		  //{
		  //    std::cout << eigen_ptsx[i] << "	" << eigen_ptsy[i] << std::endl;
		  //}
		  ...
		  //Debugging
		  //std::cout << "Coeffs are: " << coeffs[0] << ", " << coeffs[1] << ", " << coeffs[2] << ", " << coeffs[3] << std::endl;
		  ...
		  //initial_state[3] = v;
		  //initial_state[4] = cte;
		  //initial_state[5] = epsi;

		  //Debugging
		  //std::cout << "Values set up for IPOPT Solver" << std::endl;
		  //
		  ...
		  //Debugging
		  std::cout << "Steer and throttle values; " << steer_value << throttle_value << std::endl;
